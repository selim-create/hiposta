    ...
    <>
      ...
      <section className="category-network page-shell">
        ...
        <div>
          ...
          {categoryNewsletters.map((newsletter) => <NewsletterCard key={newsletter.slug} newsletter={newsletter} publication={catalog.publications.find((item) => item.slug === newsletter.publicationSlug)} showSubscriptionAction source="category_newsletter_card" />)}
