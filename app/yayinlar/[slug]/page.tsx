      ...
      <section className="publication-newsletters">
        <div className="page-shell">
          ...
          <div className="newsletter-grid">
            {publicationNewsletters.map((newsletter) => <NewsletterCard key={newsletter.slug} newsletter={newsletter} publication={publication} showSubscriptionAction source="publication_newsletter_card" />)}
