...
export const metadata: Metadata = {
  title: "Premium",
  description: "Hiposta yayın ağının derin analizlerine ve premium seçkilerine tek üyelikle eriş.",
};
...
export default async function PremiumPage() {
  ...
  const publicationCount = catalog.stats.publications;

  return (
    <>
      <section className="premium-hero">
        <div className="page-shell premium-hero__grid">
          <div><p className="eyebrow">Hiposta Premium</p><h1>Gündemi takip etme.<br /><span>Gerçekten anla.</span></h1><p>{publicationCount} yayının özel dosyaları, uzman analizleri ve haftalık dijital dergisi; sade, reklamsız ve tek üyelikte.</p><div className="premium-hero__actions"><Link className="button button--yellow" href="/kayit-ol?plan=premium">Premium’a geç <ArrowRight size={17} /></Link><small>Üyelik altyapısı hazırlanıyor.</small></div></div>
      ...
      <section className="pricing-section">
        <div className="page-shell pricing-section__inner">
          <div><p className="eyebrow">Kurucu üye dönemi</p><h2>İlk okurlar<br />arasında yerini al.</h2><p>Fiyatlar ve ödeme akışı ürün prototipi için gösterilmektedir.</p></div>
