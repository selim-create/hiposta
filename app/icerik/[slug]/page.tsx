    ...
    <article className={articleClass} style={{ "--article-accent": publication.color } as CSSProperties}>
      ...
      <div className="article-content page-shell">
        ...
        <div className="article-body">
          ...
          {locked ? <section className="paywall"><div className="paywall__icon"><Crown size={28} /></div><p className="eyebrow">İçeriğin devamı Premium’da</p><h2>Yüzeyde kalma.<br />Hikâyenin tamamını oku.</h2><p>Bu dosyanın kalan bölümleriyle birlikte {catalog.stats.publications} yayının premium analizlerine eriş.</p><ul><li><Check size={15} /> Tüm premium içerikler</li><li><Check size={15} /> Hiposta Haftalık Dergi</li><li><Check size={15} /> Reklamsız okuma deneyimi</li></ul><div><Link className="button button--yellow" href="/kayit-ol?plan=premium">Premium’a geç <ArrowRight size={16} /></Link><Link href="/giris">Zaten üye misin? Giriş yap</Link></div><small>Premium ödeme akışı henüz aktif değil.</small></section> : article.bodyHtml ? <div className="article-body__html" dangerouslySetInnerHTML={{ __html: article.bodyHtml }} /> : null}
