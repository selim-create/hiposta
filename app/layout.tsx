...
export const metadata: Metadata = {
  ...
  title: {
    default: "Hiposta — İlgi alanın kadar posta",
    template: "%s — Hiposta",
  },
  description:
    "Hip Medya’nın 17 yayınından içerikleri, premium dosyaları ve seçtiğin e-posta bültenlerini tek merkezde keşfet.",
  ...
  openGraph: {
    ...
    description: "17 yayın, tek hesap, yalnızca seçtiğin konular.",
  },
  twitter: {
