...
export default async function LoginPage({ searchParams }: Props) {
  ...
  return (
    <section className="auth-page page-shell">
      <div className="auth-page__visual"><Logo inverse compact linked={false} /><span>Tüm yayınların.<br />Tek hesap.</span><p>Bültenlerini yönet, premium içeriklerini oku ve kaldığın yerden devam et.</p></div>
