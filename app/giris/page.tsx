...
export default function LoginPage() {
  return (
    <section className="auth-page page-shell">
      ...
      <div className="auth-page__panel"><p className="eyebrow">Tekrar hoş geldin</p><h1>Hiposta’ya<br />giriş yap.</h1><p>Hesap deneyimi geliştirme aşamasında. Bu ekrandan giriş akışının ürün önizlemesini görebilirsin.</p><AuthForm mode="login" /></div>
    </section>
  );
}
