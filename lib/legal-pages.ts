...
export const legalPages: Record<string, LegalPageDefinition> = {
  ...
  cookies: {
    ...
    showCompany: true,
    sections: [
      { id: "gerekli", title: "Gerekli teknolojiler", paragraphs: ["Bu kayıtlar talep ettiğin işlevin çalışması, güvenli oturum veya gizlilik tercihinin hatırlanması için kullanılır; pazarlama amacıyla kullanılmaz."], items: ["hiposta_session — HttpOnly oturum çerezi; giriş yapan kullanıcıda oturum güvenliği için; en fazla 30 gün", "hiposta.privacy.consent — localStorage; gizlilik/analitik tercihini ve politika sürümünü hatırlamak için; en fazla 12 ay", "hiposta-newsletter-wizard-v4 — localStorage; başlattığın bülten seçim sihirbazındaki ilerlemeyi hatırlamak için; seçim tamamlandığında veya saklama süresi dolduğunda temizlenir"] },
