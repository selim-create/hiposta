  ...
  return (
    <div className={className} aria-label="İçeriği paylaş">
      ...
      <div className="article-share__actions">
        ...
        <button type="button" onClick={nativeShare} aria-label="Paylaşım menüsünü aç" title="Paylaş">
          <Share2 size={15} aria-hidden="true" />
        </button>
        <button type="button" onClick={copyLink} aria-label="Bağlantıyı kopyala" title="Bağlantıyı kopyala">
